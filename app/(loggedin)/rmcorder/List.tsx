...
import { RootState, SalesOrder, SalesOrderItem } from "@/types";
import {
  Menu,
  MenuButton,
  MenuItem,
...
export const List = ({}) => {
  ...
  const handleChangeStatus = async () => {
    ...
    toast.success("RMC Order updated successfully!");
  ...
  return (
    <div className="overflow-x-none">
      ...
      <ConfirmationModal
        ...
        message="Are you sure you want to delete this RMC order?"
      />
      <ConfirmationModal
