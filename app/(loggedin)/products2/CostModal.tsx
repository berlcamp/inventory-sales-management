...
export const CostModal = ({ isOpen, onClose, editData }: ModalProps) => {
  //
      ...
      if (editData?.id) {
        ...
        if (error) {
          ...
          await supabase.from('product_change_logs').insert({
            ...
            user_name: user?.name,
            message: `Updated purchase cost from ${editData.cost} to ${data.cost}`
          })
